...
const devicesId = "646310526" // 填写在OneNet上获得的devicesId 形式就是一串数字 例子:9939133
const api_key = "loSgFGa8gvzM=kacJr=cnZOOkMw=" // 填写在OneNet上的 api-key 例子: VeFI0HZ44Qn5dZO14AuLbWSlSlI=
...
save:function(){
  ...
  getDatapoints: function () {
    return new Promise((resolve, reject) => {
      wx.request({
        url: `https://api.heclouds.com/devices/${devicesId}/datapoints?datastream_id=xindian,Humidity&limit=1481`,
        /**
         * 添加HTTP报文的请求头, 
